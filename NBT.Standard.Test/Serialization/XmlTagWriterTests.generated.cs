  ...
  partial class XmlTagWriterTests
  {
    ...
    public void WriteListTag_writes_list_of_byte()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        Assert.Equal(expected, actual.Value.Select(tag => (byte)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_short()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (short)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_int()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (int)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_long()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (long)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_float()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (float)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_double()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (double)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_string()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (string)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_list()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (TagCollection)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteListTag_writes_list_of_compound()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        // assert
        Assert.Equal(expected.Length, actual.Count);
        Assert.Equal(expected, actual.Value.Select(tag => (TagDictionary)(tag.GetValue())).ToArray());
      }
    }
    ...
    public void WriteTag_writes_named_longarray_tag()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        expectedName = "deltalong[]";
        expectedValue = new[] { 2190654654545, 295464654694, 324546546546548, 42943564654654394 };
    ...
    public void WriteListTag_writes_list_of_longarray()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        expected = new long[][] { new long[] { 2190654654545, 295464654694 }, new long[] { 324546546546548, 42943564654654394 } };
    ...
    public void WriteTag_writes_longarray_tag()
    {
      using (MemoryStream stream = new MemoryStream())
      {
        ...
        expected = TagFactory.CreateTag("epsilonlong[]", new[] { 2190654654545, 295464654694, 324546546546548, 42943564654654394 });
